...
<body>
    ...
    <div class="topnav">
        ...
        <a href="user/inbox.php">Inbox</a>
        <a href="user/posts.php">Posts</a>   <!-- search -->
        <a href="user/pages.php">Pages</a>   <!-- search -->
        <a href="user/people.php">People</a>
    ...
    <?php
      //This block of php code gets all the posts of the profile and
      //stores it in 2D array called posts
      $sql = "SELECT * FROM post WHERE Profile_ID='$ID' ORDER BY Post_ID DESC;";
      $posts = array();
    ...
    <div class="sidebar-right">
        ...
        <!-- PHP Code to display posts of the profile -->
        ...
        <div class="posts" style="color:white;">
            ...
            <?php foreach($posts as $p): ?>
              ...
              <form action="#" method="POST">
                <input type="hidden" name="PostIDx" value="<?=$PostID;?>"/>
                <button type="submit">
                  <?php echo $p['Content'];?>
                  <br/><br>
